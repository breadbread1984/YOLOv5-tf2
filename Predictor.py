...
from models import YOLOv5, OutputParser;
...
class Predictor(object):
  ...
  def __init__(self, input_shape = (608,608,3), class_num = 80, yolov5 = None):
    ...
    if yolov5 is None:
      ...
      self.yolov5 = yolov5;
    self.parsers = [OutputParser(tuple(self.yolov5.outputs[l].shape[1:]), self.input_shape, self.anchors[l]) for l in range(3)];
  ...
  def predict(self, image, conf_thres = 0.5, nms_thres = 0.5):
    ...
    outputs = self.yolov5(images_data);
